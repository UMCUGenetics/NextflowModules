process FeatureCounts {
    ...
    script:
        ...
        """
        featureCounts -T ${task.cpus} -a ${genome_gtf} -t ${params.fc_count_type} -g ${params.fc_group_features} -o ${run_id}_${params.fc_count_type}_featureCounts.txt ${extraAttributes} -s ${featureCounts_direction} ${params.optional} ${bam_list}   
